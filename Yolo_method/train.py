...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default=ROOT / "models/yolov5s-visdrone.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/VisDrone_converted.yaml", help="dataset.yaml path")
    parser.add_argument("--hyp", type=str, default=ROOT / "data/hyps/hyp.visdrone-small.yaml", help="hyperparameters path")
    ...
    parser.add_argument("--name", default="visdrone", help="save to project/name")
...
def main(opt, callbacks=Callbacks()):
    ...
    if opt.device == '0' and not torch.cuda.is_available():
        ...
        if opt.batch_size > 8:
            opt.batch_size = 4
            LOGGER.info(f"Reduced batch size to {opt.batch_size} for CPU training")
