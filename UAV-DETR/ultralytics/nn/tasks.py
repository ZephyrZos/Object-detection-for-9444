...
def torch_safe_load(weight):
    ...
    try:
        with temporary_modules({
            ...
            return torch.load(file, map_location='cpu', weights_only=False), file  # load with weights_only=False for PyTorch 2.6 compatibility
    except Exception as e:
        # If weights_only=False fails, try with weights_only=True as fallback
        try:
            return torch.load(file, map_location='cpu', weights_only=True), file
