...
# from ultralytics.utils.torch_utils import model_info_for_loggers  # Disabled to prevent trainer object corruption
...
def on_fit_epoch_end(trainer):
    ...
    # Skip logging if trainer object is corrupted
    if isinstance(trainer, str):
        LOGGER.warning("Skipping W&B logging due to corrupted trainer object")
        return
    ...
    try:
        ...
        # Disable model_info_for_loggers to prevent trainer object corruption
        # if trainer.epoch == 0:
